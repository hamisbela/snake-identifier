    ...
    <div className="bg-gradient-to-r from-emerald-100 to-teal-100 rounded-2xl p-8 text-center">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-gray-700 mb-6">
          Help us maintain and improve our free snake identifier by supporting us.
          Your contribution helps keep this educational tool free for all reptile enthusiasts! 🐍
        </p>
        <a
